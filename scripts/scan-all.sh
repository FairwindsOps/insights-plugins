...
images=(quay.io/fairwinds/polaris:7.4 quay.io/fairwinds/nova:v3.6 us-docker.pkg.dev/fairwinds-ops/oss/pluto:v5.16 us-docker.pkg.dev/fairwinds-ops/oss/goldilocks:v4.7)
have_vulns=()

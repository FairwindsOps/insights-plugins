...
images=(quay.io/fairwinds/polaris:9.0 quay.io/fairwinds/nova:v3.9 us-docker.pkg.dev/fairwinds-ops/oss/pluto:v5.20 us-docker.pkg.dev/fairwinds-ops/oss/goldilocks:v4.13)
have_vulns=()

...
images=(quay.io/fairwinds/polaris:7.3 quayio/fairwinds/nova:v3.6 us-docker.pkg.dev/fairwinds-ops/oss/pluto:v5.13 us-docker.pkg.dev/fairwinds-ops/oss/goldilocks:v4.6)
have_vulns=()

...
plugin_projects=( falco-agent kube-bench kube-bench-aggregator kyverno-policy-sync opa prometheus rbac-reporter right-sizer trivy uploader workloads watcher )

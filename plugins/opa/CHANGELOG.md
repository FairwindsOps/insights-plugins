...
## 3.1.31
* Bump library github.com/open-policy-agent/opa to v1.18.2

## 3.1.30
* Bump library github.com/open-policy-agent/opa to v1.18.1

## 3.1.29
* Bump library github.com/open-policy-agent/opa to v1.18.0
...
## 3.1.22
* Bump library github.com/open-policy-agent/opa to v1.17.0
* Bump indirect libraries dependencies

## 3.1.21
* Bump library github.com/open-policy-agent/opa to v1.16.2

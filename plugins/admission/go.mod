...
require (
	...
	github.com/fairwindsops/pluto/v5 v5.9.1-0.20220629194848-a932cda953da
...
require (
	github.com/fairwindsops/insights-plugins/plugins/opa v0.0.0-20220302200648-3d4762d614b3

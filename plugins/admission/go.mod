...
require (
	...
	github.com/fairwindsops/insights-plugins/plugins/opa v0.0.0-20250613143236-883a20aaf1f1
...
require (
	...
	github.com/fairwindsops/insights-plugins/plugins/workloads v0.0.0-20250613143236-883a20aaf1f1 // indirect

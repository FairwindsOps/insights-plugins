...
require (
	...
	github.com/fairwindsops/polaris v0.0.0-20230622172219-4ca4c8f0f536 // 8.0.0
...
require (
	github.com/fairwindsops/insights-plugins/plugins/opa v0.0.0-20230621174559-9800e2f3357b

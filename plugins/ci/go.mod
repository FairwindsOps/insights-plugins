...
require (
	github.com/fairwindsops/insights-plugins/plugins/opa v0.0.0-20260116141616-311db4b43ebe
	github.com/fairwindsops/insights-plugins/plugins/trivy v0.0.0-20260116141616-311db4b43ebe

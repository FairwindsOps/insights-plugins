...
require (
	github.com/fairwindsops/insights-plugins/plugins/opa v0.0.0-20220718132216-40dfaced78fb
	github.com/fairwindsops/insights-plugins/plugins/trivy v0.0.0-20220718132216-40dfaced78fb

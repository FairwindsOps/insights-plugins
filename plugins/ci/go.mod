...
require (
	github.com/fairwindsops/insights-plugins/plugins/opa v0.0.0-20251216132420-1b2f39520bd8
	github.com/fairwindsops/insights-plugins/plugins/trivy v0.0.0-20251216132420-1b2f39520bd8

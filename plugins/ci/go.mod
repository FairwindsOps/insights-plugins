...
require (
	github.com/fairwindsops/insights-plugins/plugins/opa v0.0.0-20220722105424-d0f6037cd5f1
	github.com/fairwindsops/insights-plugins/plugins/trivy v0.0.0-20220722105424-d0f6037cd5f1

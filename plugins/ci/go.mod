...
require (
	github.com/fairwindsops/insights-plugins/plugins/opa v0.0.0-20240917200815-3ce13b8faae3
	github.com/fairwindsops/insights-plugins/plugins/trivy v0.0.0-20240917200815-3ce13b8faae3

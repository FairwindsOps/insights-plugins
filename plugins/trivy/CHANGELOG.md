...
* Run the gcloud layer on `python:3.13-slim-bookworm` (glibc): the SDK's bundled Python is not compatible with Alpine musl (`posix_fallocate64` and similar relocation errors).

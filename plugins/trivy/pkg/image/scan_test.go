...
func TestScanImages(t *testing.T) {
	scannerMock := func(extraFlags, pullRef string, trivyServerURL string, registryOAuth2AccessToken map[string]string) (*models.TrivyResults, error) {
...
func TestScanImagesError(t *testing.T) {
	i := 0
	errorScannerMock := func(extraFlags, pullRef string, trivyServerURL string, registryOAuth2AccessToken map[string]string) (*models.TrivyResults, error) {
		i++
...
func TestScanImagesSuccessOnRetry(t *testing.T) {
	i := 0
	successOnRetryScannerMock := func(extraFlags, pullRef string, trivyServerURL string, registryOAuth2AccessToken map[string]string) (*models.TrivyResults, error) {
		i++
		if i == 3 {
			return &models.TrivyResults{
				Metadata: models.TrivyMetadata{},

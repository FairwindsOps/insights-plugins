...
func TestCloudWatchHandlerCreatePolicyViolationEventFromAuditEvent(t *testing.T) {
	...
	assert.Equal(t, "nginx-deployment", violationEvent.Metadata["resource_name"])
	assert.Equal(t, "policy-violation-Deployment-nginx-deployment-5c0888f1-bdd0-4681-9aba-5b734c267df2", violationEvent.Name)

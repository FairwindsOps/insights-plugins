...
if [[ "$provider" == "gcp" ]]; then
  ...
  /google-cloud-sdk/bin/bq --format=prettyjson --apilog=stdout --debug_mode=true --httplib2_debuglevel=1 query --max_rows=10000000 --nouse_legacy_sql "$sql" > /output/cloudcosts-tmp.json

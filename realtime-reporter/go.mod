...
require (
	...
	github.com/fairwindsops/insights-plugins/plugins/admission v0.0.0-20251212195835-0e6b4e2b5cfa
...
require (
	...
	github.com/fairwindsops/insights-plugins/plugins/opa v0.0.0-20251212195835-0e6b4e2b5cfa // indirect

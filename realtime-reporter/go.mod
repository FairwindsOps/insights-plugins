...
require (
	...
	github.com/fairwindsops/polaris v0.0.0-20260721161925-4bdf5315b6a8
...
require (
	...
	github.com/fairwindsops/insights-plugins/plugins/opa v0.0.0-20260403203550-2d31f9d10c2d // indirect
